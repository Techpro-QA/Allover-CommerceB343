...
public class Driver {
    ...
    /*
    Bu kod sayesinde parallel test yaparken her threadin kendi driver objectine sahip olmasini sagladik
    böylece paralel olarak calisan farkli threadler birbirlerinin driver larini etkilemezler
     */
